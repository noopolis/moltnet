...
Agent registration interacts with the auth model: see [Authentication](/reference/authentication/) for how token IDs, scopes, and attachment agent allowlists affect registration and attachment identity.
