...
func (c *httpTransport) FetchNetwork(ctx context.Context, pairing protocol.Pairing) (protocol.Network, error) {
...
func (c *httpTransport) FetchRooms(ctx context.Context, pairing protocol.Pairing) ([]protocol.Room, error) {
...
func (c *httpTransport) FetchAgents(ctx context.Context, pairing protocol.Pairing) ([]protocol.AgentSummary, error) {
...
func (c *httpTransport) RelayMessage(
	ctx context.Context,
...
func (c *httpTransport) doJSON(request *http.Request, target any) error {
