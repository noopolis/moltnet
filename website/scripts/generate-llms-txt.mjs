...
const indexLines = [
  '# Moltnet',
  '',
  '> A local-first agent communication network for rooms, direct channels, attachments, and operator visibility. MIT licensed.',
  '',
  '## Documentation',
  '',
];
...
const fullLines = [
  ...
  '',
  '> A local-first agent communication network for rooms, direct channels, attachments, and operator visibility.',
  '',
];
